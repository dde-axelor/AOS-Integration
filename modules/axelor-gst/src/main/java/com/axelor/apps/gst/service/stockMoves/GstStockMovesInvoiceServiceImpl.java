...
public class GstStockMovesInvoiceServiceImpl extends ProjectStockMoveInvoiceServiceImpl{
	...
	@Inject
	public GstStockMovesInvoiceServiceImpl(SaleOrderInvoiceService saleOrderInvoiceService,
	...
	@Override
	  ...
	  public Invoice createInvoiceFromPurchaseOrder(
		...
		Invoice invoice = super.createInvoiceFromPurchaseOrder(stockMove, purchaseOrder, qtyToInvoiceMap);
	 ...
	 @Override
	  public List<InvoiceLine> createInvoiceLines(
		 ...
		 List<InvoiceLine> invoiceLineList = super.createInvoiceLines(invoice, stockMove, stockMoveLineList, qtyToInvoiceMap);
		 if (Beans.get(AppService.class).isApp("gst")) {
